      ...
      <div className="hero-inner">
        <div className="hero-content">
          ...
          <div className="hero-social" role="navigation" aria-label="Social links">
            <a href="https://github.com/shodhan07" aria-label="GitHub">
              {/* GitHub icon */}
            ...
            <a href="https://www.linkedin.com/in/shodhan-a-k-645597262/" aria-label="LinkedIn">
              {/* LinkedIn icon */}
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
            ...
            <a href="mailto:shodhangowda07@email.com" aria-label="Email">
              {/* Mail icon */}
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
