      ...
      <div className="hero-inner">
        <div className="hero-content">
          ...
          <div className="hero-social" role="navigation" aria-label="Social links">
            <a href="https://github.com/shodhan07" aria-label="GitHub" target="_blank" rel="noreferrer">
              {/* GitHub icon */}
            ...
            <a href="https://www.linkedin.com/in/shodhan-a-k-645597262/" aria-label="LinkedIn" target="_blank" rel="noreferrer">
              {/* LinkedIn icon */}
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
            ...
            <a href="mailto:shodhangowda07@email.com" aria-label="Email" target="_blank" rel="noreferrer">
              {/* Mail icon */}
              <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true">
                <path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2Zm0 4-8 5L4 8V6l8 5 8-5v2Z" />
              </svg>
            </a>
            <a href="https://leetcode.com/u/Shodhan_ak/" aria-label="LeetCode" target="_blank" rel="noreferrer">
              {/* LeetCode icon */}
              <SiLeetcode size={22} />
            </a>
          </div>
